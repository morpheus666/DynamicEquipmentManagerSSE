...
public:
	ISetting(std::string a_key) : _key(a_key) { settings.push_back(this); }
	virtual ~ISetting() {}
...
{
public:
	bSetting(std::string a_key, bool a_value) : ISetting(a_key), _value(a_value) {}
	virtual ~bSetting() {}
	...
	virtual void		dump() override { _DMESSAGE("%s: %s", _key.c_str(), (_value ? "True" : "False")); }
...
{
public:
	iSetting(std::string a_key, SInt32 a_value) : ISetting(a_key), _value(a_value) {}
	virtual ~iSetting() {}
...
{
public:
	fSetting(std::string a_key, float a_value) : ISetting(a_key), _value(a_value) {}
	virtual ~fSetting() {}
...
{
public:
	sSetting(std::string a_key, std::string a_value) : ISetting(a_key), _value(a_value) {}
	virtual ~sSetting() {}
...
public:
	aSetting(std::string a_key, std::initializer_list<std::string> a_list = {}) : ISetting(a_key), std::vector<std::string>(a_list) {}
	virtual ~aSetting() {}
