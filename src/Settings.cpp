...
bSetting	Settings::manageAmmo("manageAmmo", true);
bSetting	Settings::manageHelmet("manageHelmet", true);

const char*	Settings::FILE_NAME = "Data\\SKSE\\Plugins\\DynamicEquipmentManagerSSE.json";
